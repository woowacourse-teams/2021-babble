...
class PostTest {
    ...
    void createPostWithInvalidBytesSize() {
        ...
        assertThatThrownBy(() -> new Post("title", content.toString(), "category", "nickname", "password"));
    }
    ...
    void createPostWithInvalidTitleLength() {
        ...
        assertThatThrownBy(() -> new Post(title.toString(), "content", "category", "nickname", "password"));
    }
}
