...
include::{snippets}/../../src/docs/custom-snippets/user-list/web-socket-request.adoc[]
...
include::{snippets}/../../src/docs/custom-snippets/chat-room-update/web-socket-response.adoc[]
...
include::{snippets}/../../src/docs/custom-snippets/chat-receive/web-socket-request.adoc[]

=== HTTP Response

include::{snippets}/../../src/docs/custom-snippets/chat-receive/web-socket-response.adoc[]
