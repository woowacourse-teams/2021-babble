...
include::{snippets}/read-board/http-request.adoc[]

==== HTTP Response

include::{snippets}/read-board/http-response.adoc[]
[width="40%"]
[cols="^,^,^",options="headers"]
include::{snippets}/read-board/response-fields.adoc[]

=== 게시판 전체 조회 API

==== HTTP Request

include::{snippets}/read-boards/http-request.adoc[]

==== HTTP Response

include::{snippets}/read-boards/http-response.adoc[]
[width="40%"]
[cols="^,^,^",options="headers"]
include::{snippets}/read-boards/response-fields.adoc[]

=== 게시판 검색 API

==== HTTP Request

include::{snippets}/search-boards/http-request.adoc[]

==== HTTP Response

include::{snippets}/search-boards/http-response.adoc[]
[width="40%"]
[cols="^,^,^",options="headers"]
include::{snippets}/search-boards/response-fields.adoc[]

=== 게시판 카테고리 검색 API

==== HTTP Request

include::{snippets}/category-boards/http-request.adoc[]

==== HTTP Response

include::{snippets}/category-boards/http-response.adoc[]
[width="40%"]
[cols="^,^,^",options="headers"]
include::{snippets}/category-boards/response-fields.adoc[]
